...
tokenizer = AutoTokenizer.from_pretrained('EleutherAI/gpt-neo-2.7B', cache_dir='model_data_gpt_neo_2.7B')

config = AutoConfig.from_pretrained('EleutherAI/gpt-neo-2.7B', num_labels=151, 
...
model = GPT2Wrapper(config=config, model_name_or_path='EleutherAI/gpt-neo-2.7B', cache_dir='model_data_gpt_neo_2.7B')
